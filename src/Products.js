...
export default function Products() {
  ...
  <div className="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
    <div className="col"><Link to="/ruksaci">
      <div
    ...
    <div className="col"><Link to='/torbe'>
      <div
        className="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg"
        style={{ backgroundImage: `url(${Torba1})`, backgroundRepeat: "no-repeat", backgroundSize: "contain", backgroundPosition: "center" }}
      >
    ...
    <div className="col"><Link to='/cekeri'>
      <div
        className="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg"
        style={{ backgroundImage: `url(${Torba1})`, backgroundRepeat: "no-repeat", backgroundSize: "contain", backgroundPosition: "center" }}
      >
    ...
    <div className="col"><Link to='/neseseri'>
      <div
        className="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg"
        style={{ backgroundImage: `url(${Torba1})`, backgroundRepeat: "no-repeat", backgroundSize: "contain", backgroundPosition: "center" }}
      >
    ...
    <div className="col"><Link to='/bubrezi'>
      <div
        className="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg"
        style={{ backgroundImage: `url(${Torba1})`, backgroundRepeat: "no-repeat", backgroundSize: "contain", backgroundPosition: "center" }}
      >
